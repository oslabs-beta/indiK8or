        ...
        <Paper className="signup-paper">
          ...
          <form className="signup-form" onSubmit={handleSubmit}>
            ...
            <TextField
              ...
              helperText={
                passwordError ||
                "*Password should be at least 8 characters long and include a capital letter, a number, and a symbol."
              }
            ...
            <TextField
              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment position="end">
                    <IconButton
                      onClick={handleShowPasswordConfirmationToggle}
                      edge="end"
                    >
          ...
          <div className="snackbar-container">
            ...
            <Snackbar
              ...
              autoHideDuration={3000}
              onClose={handleConflictSnackbarClose}
            >
